          ...
          <div>
            {filteredWipJobs.length === 0 ? (
              ...
              filteredWipJobs.map((jc) => (
                <div
                  key={jc.jobCardNo}
                  className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200/90 dark:border-slate-800 space-y-3 shadow-xs"
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-xs font-extrabold font-mono text-slate-900 dark:text-white">{jc.orderQty || 0} KG</span>
                    </div>
                  </div>
